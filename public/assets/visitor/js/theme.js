...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/assets/visitor/css/theme-dark-rtl.css');
          } else {
              style.setAttribute('href', '/assets/visitor/css/theme-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/assets/visitor/css/theme-rtl.css');
          } else {
              style.setAttribute('href', '/assets/visitor/css/theme.css');
          }
